...
;   simulated display, which must be activated:
;   -- Whan using the simulator: Uncomment (remove the ";" at the begin of the line) the following statement:
;                          SIMULATOR: EQU 1
;   -- When using the Dragon12 board, this line must be commented out (insert the ";" again)!
